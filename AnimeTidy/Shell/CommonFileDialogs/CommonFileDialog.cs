...
using AnimeTidyPack.Controls;
using AnimeTidyPack.Dialogs.Controls;
using AnimeTidyPack.Shell;
using AnimeTidyPack.Shell.Resources;
using AnimeTidyPack.Internal;
using System.Collections.Generic;

namespace AnimeTidyPack.Dialogs
{
    /// <summary>
