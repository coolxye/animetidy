...
using System.Text;
using AnimeTidyPack.Shell.PropertySystem;
using AnimeTidyPack.Taskbar;
...
#pragma warning disable 108
    ...
    interface IThumbnailCache
    {
		...
		[In] AnimeTidyPack.Shell.ShellNativeMethods.ThumbnailOptions flags,
        [Out] out ISharedBitmap ppvThumb,
		[Out] out AnimeTidyPack.Shell.ShellNativeMethods.ThumbnailCacheOptions pOutFlags,
		[Out] AnimeTidyPack.Shell.ShellNativeMethods.ThumbnailId pThumbnailID);

		void GetThumbnailByID([In] AnimeTidyPack.Shell.ShellNativeMethods.ThumbnailId thumbnailID,
        [In] uint cxyRequestedThumbSize,
        [Out] out ISharedBitmap ppvThumb,
		[Out] out AnimeTidyPack.Shell.ShellNativeMethods.ThumbnailCacheOptions pOutFlags);
    }
